			...
			case LOOKUPSWITCH:
				{
					...
					log::debug("switch %d defaultvalue:%d npairs:%d\n", key, default_value, npairs);
#if 1
					//case是排好序的，可以折半搜索
